...
export function BillingForm({ isLoading, onSubmit }: BillingFormType) {
  ...
  function validateForm() {
    return (stripe && elements && fields.name !== "" &&
      fields.storage !== "" && isCardComplete);
  }
  ...
  return (
    <Form className="BillingForm" onSubmit={handleSubmitClick}>
      ...
      <Stack gap={3}>
        ...
        <LoaderButton size="lg" type="submit" isLoading={isLoading} disabled={!validateForm()}>Purchase</LoaderButton>
      </Stack>
